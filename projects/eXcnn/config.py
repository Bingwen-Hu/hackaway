...
tf.app.flags.DEFINE_integer('charset', CHARSET, "Charset to recognize")
...
tf.app.flags.DEFINE_string('train_data_dir', '', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', '', 'the test dataset dir')
