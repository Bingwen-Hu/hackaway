...
image_path = 'aug_train'
annotation_path = "aug_train.csv"
classes_path = "classes.txt"
savename = "aug_signal.json"
...
image_names = [f for f in os.listdir(os.path.join(root, image_path))]
print("number of images is: ", len(image_names))


with open(os.path.join(root, annotation_path)) as f:
...
for image_i, image_name in enumerate(image_names):
    img = cv2.imread(f"{root}/{image_path}/{image_name}")
