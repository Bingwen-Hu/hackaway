// implement asprintf using vsnprintf
...
// the declaration, to put into a .h file. The __attribute__ tells the
// compiler to support it; just remove it if yours doesn't
