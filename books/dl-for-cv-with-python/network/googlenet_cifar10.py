...
from pyimage.nn.conv import MiniGoogleNet
...
aug = ImageDataGenerator(width_shift_range=0.1, height_shift_range=.1,
...
model = MiniGoogleNet.bulid(width=32, height=32, depth=3, classes=10)
